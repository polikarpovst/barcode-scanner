 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */var $=document.createElement("template"),D=`
  :host {
    --me-width: 32rem;
 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */function tw(t){return null!==t&&"object"==typeof t?"share"in navigator&&"canShare"in navigator&&navigator.canShare(t):"share"in navigator}ty.defineCustomElement();let tE=`
  :host {
    box-sizing: border-box;
  }
...
`;class tx extends HTMLElement{constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tA.content.cloneNode(!0))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}static get observedAttributes(){return["value"]}attributeChangedCallback(t,e,o){"value"===t&&e!==o&&this.#R(this.value)}connectedCallback(){if(this.#_("value"),!tw()){let t=this.shadowRoot.querySelector("web-share");t&&(t.hidden=!0)}let t=this.shadowRoot.querySelector(".result__comment");t?.addEventListener("input",this.#M.bind(this))}#M(t){this.comment=t.target.value;let e=document.querySelector("bs-history");e&&e.updateLatestComment(this.comment)}async #R(t){let e;let o=this.shadowRoot.querySelector(".result"),i=o?.querySelector(".result__actions"),r=o?.querySelector(".result__item");r&&r.remove();try{let[,o]=await J();new URL(t),(e=document.createElement("a")).href=t,window.requestAnimationFrame(()=>e.focus()),o?.openWebPageSameTab||(e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")),o?.openWebPage&&e.click()}catch{e=document.createElement("span")}e.className="result__item",e.classList.toggle("result__item--no-barcode",t===F),e.textContent=t,o?.insertBefore(e,i);let s=t!==F,a=o?.querySelector("custom-clipboard-copy"),n=o?.querySelector("web-share");a&&s?(a.setAttribute("value",t),a.hidden=!1):(a.hidden=!0,a.removeAttribute("value")),n&&tw()&&s?(n.setAttribute("share-text",t),n.hidden=!1):(n.hidden=!0,n.removeAttribute("share-text"));let l=document.querySelector("bs-history");l&&s&&l.add({item:t,comment:""})}#_(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-result"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tx)}}tx.defineCustomElement();class tC extends HTMLElement{#q=null;#N=null;#O=[];#H;constructor(){super()}get supportedFormats(){return this.#O}set supportedFormats(t){this.#O=t,this.#I()}async connectedCallback(){this.#_("supportedFormats"),this.#q=this.querySelector("#formatsList"),this.#N=this.querySelector("form");let[,t]=await J();this.#H=t??{},this.#N?.querySelectorAll('[name="general-settings"]').forEach(t=>{t.checked=this.#H[t.value]})}#I(){if(!this.#q)return;let t=this.#H?.formats;this.#q.replaceChildren(),this.supportedFormats.forEach(e=>{let o=document.createElement("li"),i=document.createElement("label"),r=document.createElement("input");r.type="checkbox",r.name="formats-settings",r.value=e,r.checked=null==t||t.includes(e),i.appendChild(r),i.appendChild(document.createTextNode(e)),o.appendChild(i),this.#q.appendChild(o)})}#_(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-settings"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tC)}}tC.defineCustomElement();let tk=`
  :host {
...
`;class tS extends HTMLElement{#B=null;#$=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tL.content.cloneNode(!0))}async connectedCallback(){this.#B=this.shadowRoot?.getElementById("historyList"),this.#$=this.shadowRoot?.getElementById("emptyHistoryBtn");let t=this.shadowRoot?.getElementById("exportCsvBtn");this.#D((await X())[1]||[]),this.#B?.addEventListener("click",this.#F),this.#$?.addEventListener("click",this.#P),t?.addEventListener("click",this.#j)}disconnectedCallback(){this.#B?.removeEventListener("click",this.#F),this.#$?.removeEventListener("click",this.#P)}async add(t){let[,e]=await J();if(!t?.item||!e?.addToHistory)return;let[o,i=[]]=await X();if(!o&&Array.isArray(i)){let e=[...i,t],[o]=await Q(e);o||this.#D(e)}}async remove(t){if(!t)return;let[e,o=[]]=await X();if(!e&&Array.isArray(o)){let e=o.filter(e=>e.item!==t),[i]=await Q(e);if(!i){let e=this.#B.querySelector(`li[data-value="${t}"]`);e&&e.remove()}}}async empty(){let[t]=await Q([]);t||this.#B.replaceChildren()}#D(t){if(!this.#B)return;this.#B.replaceChildren();let e=document.createDocumentFragment();t.forEach(t=>{e.appendChild(this.#V(t.item,t.comment))}),this.#B.appendChild(e)}#V(t,e=""){let o,i;console.log([t,e]);let r=window.crypto&&"function"==typeof window.crypto.randomUUID?window.crypto.randomUUID():Array.from({length:5},()=>Math.random().toString(36).substring(2,8)).join("-"),s=document.createElement("li");s.setAttribute("data-value",t);try{new URL(t),(o=document.createElement("a")).href=t,o.setAttribute("target","_blank"),o.setAttribute("rel","noreferrer noopener")}catch{o=document.createElement("span")}o.textContent=t,o.setAttribute("id",`historyItem-${r}`),(i=document.createElement("span")).textContent=e,i.setAttribute("id",`historyItemComment-${r}`),i.className="comment";let a=document.createElement("div");a.className="actions";let n=document.createElement("custom-clipboard-copy");n.setAttribute("id",`copyHistoryItem-${r}`),n.setAttribute("aria-label","Copy to clipboard"),n.setAttribute("aria-labelledby",`copyHistoryItem-${r} historyItem-${r}`),n.setAttribute("only-icon",""),n.setAttribute("value",t),a.appendChild(n);let l=document.createElement("button");return l.type="button",l.className="delete-action",l.setAttribute("data-action","delete"),l.setAttribute("id",`removeHistoryItem-${r}`),l.setAttribute("aria-label","Remove from history"),l.setAttribute("aria-labelledby",`removeHistoryItem-${r} historyItem-${r}`),l.innerHTML=`
      <svg xmlns="http://www.w3.org/2000/svg" width="1.125em" height="1.125em" fill="currentColor" viewBox="0 0 16 16">
        <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
      </svg>
    `,a.appendChild(l),s.appendChild(o),s.appendChild(i),s.appendChild(a),s}#F=t=>{let e=t.target;if(e.closest('[data-action="delete"]')){let t=e.closest("li").dataset.value;window.confirm(`Delete history item ${t}?`)&&this.remove(t)}};#P=()=>{window.confirm("Empty history? This action cannot be undone.")&&this.empty()};#j=async()=>{let[t,e=[]]=await X();if(t||!Array.isArray(e))return;let o=encodeURI("data:text/csv;charset=utf-8,"+e.map(t=>`${t.item},${t.comment}`).join("\n")),i=document.createElement("a");i.setAttribute("href",o),i.setAttribute("download","barcode_history.csv"),document.body.appendChild(i),i.click(),document.body.removeChild(i)};async updateLatestComment(t){let[e,o=[]]=await X();if(e||!Array.isArray(o)||0===o.length)return;o[o.length-1].comment=t;let[i]=await Q(o);if(!i){let e=this.#B.lastElementChild;if(e){let o=e.querySelector(".comment");o&&(o.textContent=t)}}}static defineCustomElement(t="bs-history"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tS)}}tS.defineCustomElement(),async function(){let t;let e=document.querySelector("a-tab-group"),o=document.querySelector("video-capture"),i=document.querySelector("bs-settings"),r=document.querySelector("bs-history"),s=document.getElementById("cameraPanel"),a=document.getElementById("filePanel"),n=document.getElementById("scanInstructions"),l=document.getElementById("scanBtn"),d=document.getElementById("dropzone"),c=document.querySelector("resize-observer"),h=document.getElementById("scanFrame"),u=document.getElementById("torchButton"),m=document.getElementById("globalActions"),p=document.getElementById("historyBtn"),b=document.getElementById("historyDialog"),g=document.getElementById("settingsBtn"),v=document.getElementById("settingsDialog"),f=document.getElementById("settingsForm"),y=document.getElementById("cameraSelect"),w=!0;"function"==typeof HTMLDialogElement&&(m?.removeAttribute("hidden"),b?.removeAttribute("hidden"),v?.removeAttribute("hidden"));let{barcodeReaderError:E}=await tn.setup();if(E){let t=document.getElementById("barcodeReaderError");w=!1,m?.setAttribute("hidden",""),e?.setAttribute("hidden",""),t?.removeAttribute("hidden"),t.textContent=E?.message;return}let A=await tn.getSupportedFormats(),[,x]=await J(),C=x?.formats||A,k=await tn.create(C);o.addEventListener("video-capture:video-play",T,{once:!0}),o.addEventListener("video-capture:error",function(t){let e=t.detail.error;if("NotFoundError"===e.name)return;let o="NotAllowedError"===e.name?"Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;s.innerHTML=`<div class="alert alert-danger" role="alert" style="margin: 0;">${o}</div>`},{once:!0}),tu.defineCustomElement();let L=o?.shadowRoot,S=L?.querySelector("video"),z=L?.querySelector('[part="actions-container"]');async function _(){n?.removeAttribute("hidden");try{let e=await k.detect(S),o=e?.rawValue??"";if(!o)throw Error(F);window.cancelAnimationFrame(t),te(s,o),r?.add(o),n?.setAttribute("hidden",""),l?.removeAttribute("hidden"),h?.setAttribute("hidden",""),z?.setAttribute("hidden",""),tr();return}catch{}w&&(t=window.requestAnimationFrame(()=>_()))}async function T(t){h?.removeAttribute("hidden"),ts(t.detail.video,h),_();let e=t.target.getTrackSettings(),i=t.target.getTrackCapabilities(),r=document.getElementById("zoomLevel");if(i?.torch&&(u?.addEventListener("click",M),u?.removeAttribute("hidden"),o.hasAttribute("torch")&&tl({el:u,isTorchOn:!0})),e?.zoom&&i?.zoom){let t=document.getElementById("zoomControls"),s=i?.zoom?.min||0,a=i?.zoom?.max||10,n=e?.zoom||1;t?.addEventListener("click",t=>{let e=t.target.closest('[data-action="zoom-in"]'),i=t.target.closest('[data-action="zoom-out"]');e&&n<a&&(n+=.5),i&&n>s&&(n-=.5),r.textContent=n.toFixed(1),o.zoom=n}),t?.removeAttribute("hidden"),r.textContent=n.toFixed(1)}let s=await tu.getVideoInputDevices();s.forEach((t,e)=>{let o=document.createElement("option");o.value=t.deviceId,o.textContent=t.label||`Camera ${e+1}`,y.appendChild(o)}),s.length>1&&(y?.addEventListener("change",q),y?.removeAttribute("hidden"))}async function R(t){t.preventDefault();let e={},o=new FormData(f),i=o.getAll("general-settings"),r=o.getAll("formats-settings");i.forEach(t=>e[t]=!0),e.formats=r,K(e),"formats-settings"===t.target.name&&(k=await tn.create(r))}function M(t){o.torch=!o.torch,tl({el:t.currentTarget,isTorchOn:o.hasAttribute("torch")})}function q(t){if("function"!=typeof o.restartVideoStream)return;let e=t.target.value||void 0;o.restartVideoStream(e)}d.accept=P.join(","),i.supportedFormats=A,l.addEventListener("click",function(){l?.setAttribute("hidden",""),h?.removeAttribute("hidden"),z?.removeAttribute("hidden"),s&&s.querySelector("bs-result")?.remove(),_()}),e.addEventListener("a-tab-show",tt(function(t){let e=t.detail.tabId,o=document.querySelector("video-capture");if("cameraTab"===e){if(w=!0,!o)return;let t=null!=s.querySelector("bs-result");if(o.loading||t||(h?.removeAttribute("hidden"),z?.removeAttribute("hidden"),_()),"function"==typeof o.startVideoStream){let t=y?.value||void 0;o.startVideoStream(t)}}else"fileTab"===e&&(w=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream(),h?.setAttribute("hidden",""),z?.setAttribute("hidden",""))},250)),d.addEventListener("files-dropzone-drop",function(t){!function(t){if(!t)return;let e=new Image,o=new FileReader;o.onload=o=>{let i=o.target.result;e.onload=async()=>{try{let t=await k.detect(e),o=t?.rawValue??"";if(!o)throw Error(F);te(a,o),r?.add(o),tr()}catch(t){te(a,F),tr({success:!1})}},e.src=i,e.alt="Image preview",d.replaceChildren();let s=document.createElement("div");s.className="dropzone-preview";let n=document.createElement("div");n.className="dropzone-preview__image-wrapper";let l=document.createElement("div");l.className="dropzone-preview__file-name",l.textContent=t.name,n.appendChild(e),s.appendChild(n),s.appendChild(l),d.prepend(s)},o.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),c.addEventListener("resize-observer:resize",function(){ts(o.shadowRoot.querySelector("video"),h)}),g.addEventListener("click",function(){v.open=!0}),f.addEventListener("change",tt(R,500)),p.addEventListener("click",function(){b.open=!0}),document.addEventListener("visibilitychange",function(){if("cameraTab"===e.querySelector("[selected]").getAttribute("id")){if("hidden"===document.visibilityState)w=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream();else{w=!0;let t=document.querySelector("video-capture");if(!t)return;if(t.loading||s.querySelector("bs-result")||_(),"function"==typeof t.startVideoStream){let e=y?.value||void 0;t.startVideoStream(e)}}}}),document.addEventListener("keydown",function(t){"Escape"===t.key&&function(){let t=e.querySelector("#cameraTab").hasAttribute("selected"),o=!l.hidden,i=v.hasAttribute("open"),r=b.hasAttribute("open");o&&t&&!(i||r)&&l.click()}()})}()}();
//# sourceMappingURL=index.17275d85.js.map
